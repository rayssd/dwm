...
static const char col_gray5[]       = "#292929";
...
static const char *ki[] = {"kbbrightness", "1", NULL};
static const char *kd[] = {"kbbrightness", "0", NULL};

static const char *ai[] = {"pactl", "set-sink-volume", "0", "+5%", NULL};
static const char *ad[] = {"pactl", "set-sink-volume", "0", "-5%", NULL};
...
static Key keys[] = {
	/* modifier                     key        function        argument */
        ...
        {0,                XF86KbdBrightnessDown,  spawn,          {.v = kd}},
        {0,                  XF86KbdBrightnessUp,  spawn,          {.v = ki}},
        
        {0,                 XF86AudioLowerVolume,  spawn,          {.v = ad}},
        {0,                 XF86AudioRaiseVolume,  spawn,          {.v = ai}},
